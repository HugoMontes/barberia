<div class="footer-area section-bg" data-background="{{ asset('web/assets/img/gallery/footer_bg.png') }}">
    <div class="container">
                ...
                <div class="col-xl-3 col-lg-4 col-md-5 col-sm-8">
                    <div class="single-footer-caption mb-50">
                        ...
                        <div class="footer-logo">
                            <a href="index.html"><img src="{{ asset('web/assets/img/logo/logo2_footer.png') }}"
                                    alt=""></a>
                        </div>
