...
@section('content')
    ...
    <section class="about-area section-padding30 position-relative">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-11">
                    <!-- about-img -->
                    <div class="about-img ">
                        <img src="{{ asset('web/assets/img/gallery/about.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="about-caption">
                        ...
                        <p class="pera-top mb-50">Brook presents your services with flexible, convefnient and ent anipurpose
                            layouts. You can select your favorite.</p>
                        <img src="{{ asset('web/assets/img/gallery/signature.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="about-shape">
            <img src="{{ asset('web/assets/img/gallery/about-shape.png') }}" alt="">
        </div>
    </section>
    <!-- About-2 Area End -->
    <!--? Services Area Start -->
    ...
    <div class="best-pricing section-padding2 position-relative">
        ...
        <div class="pricing-img">
            <img class="pricing-img1" src="{{ asset('web/assets/img/gallery/pricing1.png') }}" alt="">
            <img class="pricing-img2" src="{{ asset('web/assets/img/gallery/pricing2.png') }}" alt="">
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="box snake mb-30">
                        <div class="gallery-img "
                            style="background-image: url({{ asset('web/assets/img/gallery/gallery1.png') }});"></div>
                ...
                <div class="col-lg-8 col-md-6 col-sm-6">
                    <div class="box snake mb-30">
                        <div class="gallery-img "
                            style="background-image: url({{ asset('web/assets/img/gallery/gallery2.png') }});"></div>
                        <div class="overlay"></div>
                    </div>
                </div>
                <div class="col-lg-8 col-md-6 col-sm-6">
                    <div class="box snake mb-30">
                        <div class="gallery-img "
                            style="background-image: url({{ asset('web/assets/img/gallery/gallery3.png') }});"></div>
                        <div class="overlay"></div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="box snake mb-30">
                        <div class="gallery-img "
                            style="background-image: url({{ asset('web/assets/img/gallery/gallery4.png') }});"></div>
                        <div class="overlay"></div>
                    </div>
                </div>
            </div>
